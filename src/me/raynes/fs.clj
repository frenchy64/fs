...
(s/fdef
  ...
  :ret
  (partial instance? java.io.File))
(s/def ::alias__16986 (s/and (partial instance? java.io.File)))
(s/def ::alias__16988 set?)
(s/def
  ::alias__16989
  (s/or
    :nil?
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18265 (partial instance? java.io.File) :string? string?))
  :ret
  (s/coll-of (partial instance? java.io.File)))
(s/fdef
  assert-exists
  ...
  (s/cat
    :path
    (s/or :G__18266 (partial instance? java.io.File) :string? string?))
  :ret
  nil?)
(s/fdef
  split-ext
...
(s/def ::alias__17177 nil?)
(s/def ::alias__17176 (s/and (partial instance? java.io.File)))
(s/fdef
  find-files*
  :args
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18268 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  move
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18269 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  link
...
(s/fdef
  ...
  :ret
  (partial instance? java.io.File))
(s/def ::alias__17337 (s/and (partial instance? java.io.File)))
(s/def ::alias__17338 boolean?)
(s/fdef
  temp-create
  :args
...
(s/fdef
  ...
  (s/cat
    ...
    string?
    :path
    (s/or :G__18270 (partial instance? java.io.File) :string? string?))
  :ret
  (s/or :G__18271 (partial instance? java.io.File) :string? string?))
(s/fdef
  file?
  :args
  (s/cat
    :path
    (s/or :G__18272 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  expand-home
...
(s/fdef
  ...
  (s/cat
    :f
    (s/or :G__18273 (partial instance? java.io.File) :string? string?))
  :ret
  (s/or
    :nil?
    nil?
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18275 (partial instance? java.io.File) :string? string?))
  :ret
  (s/coll-of string?))
(s/fdef
  executable?
  ...
  (s/cat
    :path
    (s/or :G__18276 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  extension
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18277 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  f-dir?
...
(s/fdef
  ...
  (s/cat
    ...
    (partial instance? java.io.File)
    :target
    (s/or :G__18278 (partial instance? java.io.File) :string? string?))
  :ret
  (partial instance? java.io.File))
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18280 (partial instance? java.io.File) :string? string?))
  :ret
  (partial instance? sun.nio.fs.UnixPath))
(s/fdef
  walk-map-fn
...
(s/fdef
  ...
  (s/cat :path (partial instance? java.io.File))
  :ret
  (s/or :G__18281 (partial instance? java.io.File) :nil? nil?))
(s/fdef
  base-name
  :args
  (s/alt
...
(s/fdef
  ...
  (s/cat
    :path
    (s/or :G__18284 (partial instance? java.io.File) :string? string?))
  :ret
  boolean?)
(s/fdef
  find-files
...
(s/fdef
  ...
  (s/cat
    :old-path
    (s/or :G__18285 (partial instance? java.io.File) :string? string?)
    :new-path
    string?)
  :ret
  boolean?)
(s/fdef
  ...
  (s/cat
    ...
    string?
    :path
    (s/or :G__18286 (partial instance? java.io.File) :string? string?))
  :ret
  (s/or :G__18287 (partial instance? java.io.File) :string? string?))
(s/fdef
  temp-file
  :args
  (s/alt
...
(s/fdef
  ...
  :ret
  (s/or :G__18288 (partial instance? java.io.File) :nil? nil?))
